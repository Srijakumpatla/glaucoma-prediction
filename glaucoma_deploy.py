...
label_encoder.classes_ = ['Normal', 'Glaucoma']  # Replace with your trained class names
...
if st.sidebar.button("Predict"):
    input_df = preprocess_input()  # returns a proper DataFrame
    try:
        pred_numeric = logreg.predict(input_df)  # 2D array/DataFrame input
