...
try:
    ...
    st.error("Model file 'glaucoma_model.pkl' not found. Please make sure it is in the same directory.")
    st.stop()
...
if st.sidebar.button("Predict"):
    ...
    try:
        # Make prediction
        pred_numeric = logreg.predict(input_df)             # Returns array like [1]
