...
# Define label encoder to decode numeric predictions
label_encoder = LabelEncoder()
label_encoder.classes_ = ['Normal', 'Glaucoma']  # Replace with your actual class names
...
# Preprocess input to match trained model's features
...
if st.sidebar.button("Predict"):
    ...
    try:
        pred_numeric = logreg.predict(input_df)[0]  # numeric output
        prediction = label_encoder.inverse_transform([pred_numeric])[0]  # convert to string
